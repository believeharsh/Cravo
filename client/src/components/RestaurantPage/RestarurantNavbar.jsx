...
const RestaurantNavbar = ({ 
    ...
    const sortOptions = [
        ...
        { id: 'deliveryTime', label: 'Delivery Time', description: 'Fastest first' },
        ...
        { id: 'popularity', label: 'Popularity', description: 'Most ordered first' }
    ];
    ...
    return (
        <div className={`fixed top-0 left-0 right-0 z-40 transition-transform duration-300 ease-in-out ${
                                    ...
                                    <div className="absolute right-0 top-full mt-2 w-80 bg-white border border-gray-200 rounded-2xl shadow-lg">
                                        ...
                                        <div className="p-4 max-h-80 overflow-y-auto">
                                            <div className="space-y-4">
                                                <div>
                                                    <h4 className="font-semibold text-gray-800 mb-3">Quick Filters</h4>
