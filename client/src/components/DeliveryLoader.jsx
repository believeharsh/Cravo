    ...
    <div className="fixed inset-0 bg-white flex items-center justify-center z-50">
      <div className="text-center">
        ...
        <div className="text-center">
          ...
          <p className="text-gray-600 mb-4">Preparing your delicious experience...</p>
      ...
      <style jsx={"true"}>{`
        ...
        @keyframes ride {
          ...
          25% { transform: translateX(80px) translateY(-2px); }
          50% { transform: translateX(160px) translateY(0px); }
          75% { transform: translateX(240px) translateY(-1px); }
        ...
        @keyframes roadMove {
          ...
          100% { transform: translateX(-20px) translateY(-50%); }
        }
      `}</style>
    </div>
  );
