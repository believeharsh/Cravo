    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
      ...
      <div className="relative overflow-hidden bg-gradient-to-br from-gray-900 via-gray-800 to-black">
        ...
        <div className="relative z-10 mx-auto max-w-7xl px-4 py-20 md:py-28">
          <div className="mx-auto max-w-4xl text-center">
            <div className="bg-primary/20 border-border-focus/30 mb-8 inline-flex items-center gap-2 rounded-full border px-5 py-2.5 text-sm font-bold text-yellow-400 shadow-lg backdrop-blur-xl">
            ...
            <div className="mb-16 flex flex-col justify-center gap-4 sm:flex-row">
              <button
                ...
                className="group bg-primary hover:bg-primary-hover text-text-main flex items-center justify-center gap-2 rounded-2xl px-8 py-4 font-bold shadow-xl transition-all hover:shadow-2xl"
              >
                Get Started
                <ArrowRight className="h-5 w-5 transition-transform group-hover:translate-x-1" />
              </button>
              <button className="group hover:text-text-main flex items-center justify-center gap-2 rounded-2xl border-2 border-white/30 px-8 py-4 font-bold text-white backdrop-blur-xl transition-all hover:bg-white">
                ...
                return (
                  ...
                  >
                    <div className="bg-primary mx-auto mb-3 flex h-12 w-12 items-center justify-center rounded-xl">
                      <Icon className="text-text-main h-6 w-6" />
                    </div>
      ...
      <div className="mx-auto max-w-7xl px-4 py-20">
        <div className="mb-16 text-center">
          ...
          <h2 className="text-text-main mb-4 text-4xl font-bold md:text-5xl">
        ...
        <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
          {corporateFeatures.map((feature, i) => {
            ...
            return (
              <div
                key={i}
                className="group border-border hover:border-border-focus rounded-2xl border bg-white p-8 transition-all duration-300 hover:shadow-2xl"
              >
                <div className="to-primary-hover mb-6 flex h-16 w-16 items-center justify-center rounded-2xl bg-gradient-to-br from-yellow-400 shadow-lg transition-transform group-hover:scale-110">
                  <Icon className="text-text-main h-8 w-8" />
                </div>
          ...
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
            {useCases.map((useCase, i) => {
              ...
              return (
                <div
                  key={i}
                  className="border-border rounded-2xl border bg-white p-6 text-center transition-all hover:shadow-xl"
                >
      ...
      <div className="mx-auto max-w-7xl px-4 py-20">
        ...
        <div className="grid gap-8 md:grid-cols-3">
          {pricingPlans.map(plan => (
            <div
              key={plan.id}
              className={`relative rounded-3xl border-2 bg-white p-8 transition-all hover:shadow-2xl ${
                plan.popular
                  ? 'border-border-focus scale-105 shadow-xl'
                  : 'border-border'
              }`}
            >
              {plan.popular && (
                <div className="absolute -top-4 left-1/2 -translate-x-1/2">
                  <span className="to-primary-hover text-text-main rounded-full bg-gradient-to-r from-yellow-400 px-5 py-2 text-sm font-bold shadow-lg">
                    Most Popular
                  </span>
                </div>
              )}
              ...
              <div className="mb-8 text-center">
                <h3 className="text-text-main mb-2 text-2xl font-bold">
                  {plan.name}
                </h3>
                <p className="text-text-secondary mb-6">{plan.description}</p>
                <div className="mb-4">
                  <span className="text-text-main text-5xl font-bold">
                    {plan.price}
                  </span>
              ...
              <button
                ...
                className={`w-full rounded-2xl py-4 font-bold transition-all ${
                  plan.popular
                    ...
                    : 'text-text-main bg-gray-100 hover:bg-gray-200'
                }`}
              >
        ...
        <div className="mx-auto max-w-7xl px-4">
          ...
          <div className="grid gap-8 md:grid-cols-3">
            {testimonials.map((testimonial, i) => (
              <div
                key={i}
                className="border-border rounded-2xl border bg-white p-8 transition-all hover:shadow-xl"
              >
                <div className="mb-6">
      ...
      <div className="mx-auto max-w-7xl px-4 py-20">
        <div className="to-primary-hover relative overflow-hidden rounded-3xl bg-gradient-to-r from-yellow-400 p-12 text-center md:p-16">
          ...
          <div className="relative">
            <h2 className="text-text-main mb-6 text-4xl font-bold md:text-5xl">
              Ready to Supercharge Your Team Meals?
            </h2>
            <p className="text-text-main mx-auto mb-8 max-w-2xl text-xl">
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 px-4 backdrop-blur-sm">
          <div className="relative max-h-[90vh] w-full max-w-2xl overflow-y-auto rounded-3xl bg-white p-8 shadow-2xl">
            <button
              ...
              className="text-text-secondary hover:text-text-main absolute top-6 right-6 flex h-10 w-10 items-center justify-center rounded-full bg-gray-100 transition-colors hover:bg-gray-200"
            >
              <X className="h-5 w-5" />
            </button>

            <h3 className="text-text-main mb-2 text-3xl font-bold">
              Let's Talk
            </h3>
            ...
            <div className="space-y-5">
              ...
              <button
                ...
                className="bg-primary hover:bg-primary-hover text-text-main flex w-full items-center justify-center gap-2 rounded-xl py-4 font-bold shadow-lg transition-all hover:shadow-xl"
              >
                Submit Request
                <ArrowRight className="h-5 w-5" />
              </button>
