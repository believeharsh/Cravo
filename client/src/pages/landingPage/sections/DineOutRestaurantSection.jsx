      ...
      <div className="max-w-6xl mx-auto">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-6">
            <div className="inline-flex items-center gap-2 bg-gradient-to-r from-yellow-400 to-primary-hover text-text-main px-5 py-2 rounded-full text-sm font-bold shadow-lg shadow-yellow-200">
            ...
            <div className="grid grid-cols-1 gap-2 pt-2">
              <div className="group cursor-pointer flex items-start gap-4 p-4 bg-white rounded-2xl border border-gray-100 hover:border-yellow-300 hover:shadow-lg transition-all duration-300">
                <div className="w-12 h-12 bg-gradient-to-br from-yellow-400 to-primary-hover rounded-xl flex items-center justify-center shadow-md group-hover:scale-110 transition-transform">
                  <Icon name="star" className="w-6 h-6 text-text-main" />
                </div>
                <div>
              ...
              <div className=" cursor-pointer group flex items-start gap-4 p-4 bg-white rounded-2xl border border-gray-100 hover:border-yellow-300 hover:shadow-lg transition-all duration-300">
                <div className="w-12 h-12 bg-gradient-to-br from-yellow-400 to-primary-hover rounded-xl flex items-center justify-center shadow-md group-hover:scale-110 transition-transform">
                  <Icon name="map-pin" className="w-6 h-6 text-text-main" />
                </div>
                <div>
                  <p className="font-bold text-text-main mb-1">
                    Prime Locations
              ...
              <div className=" cursor-pointer group flex items-start gap-4 p-4 bg-white rounded-2xl border border-gray-100 hover:border-yellow-300 hover:shadow-lg transition-all duration-300">
                <div className="w-12 h-12 bg-gradient-to-br from-yellow-400 to-primary-hover rounded-xl flex items-center justify-center shadow-md group-hover:scale-110 transition-transform">
                  <Icon name="clock" className="w-6 h-6 text-text-main" />
                </div>
                <div>
                  <p className="font-bold text-text-main mb-1">
                    Instant Reservation
            ...
            <Link to={'restaurants/dine-out'}>
              <button className="cursor-pointer group bg-gradient-to-r from-yellow-400 to-primary-hover hover:from-yellow-500 hover:to-yellow-600 text-text-main font-bold px-8 py-4 rounded-2xl transition-all shadow-lg shadow-yellow-200 hover:shadow-xl hover:shadow-yellow-300 flex items-center gap-3 hover:gap-4">
          ...
          <div className="relative">
            ...
            <div className="absolute -bottom-6 -left-6 bg-white rounded-2xl shadow-xl p-2 border border-gray-100">
              <div className="flex items-center gap-4">
                <div className="w-10 h-10 bg-gradient-to-br from-yellow-400 to-primary-hover rounded-2xl flex items-center justify-center shadow-lg">
                  <Icon
                    name="star"
                    className="w-3 h-3 fill-gray-900 text-text-main"
                  />
                </div>
                <div>
                  <p className="text-sm font-bold text-text-main">4.8</p>
            ...
            <div className="absolute top-6 right-6 bg-white/95 backdrop-blur-sm rounded-xl px-4 py-2 shadow-lg">
              <p className="text-xs font-semibold text-text-secondary">FEATURED</p>
            </div>
          </div>
        </div>
      </div>
