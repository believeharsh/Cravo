  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-yellow-50 to-white flex items-center justify-center px-4">
      ...
      <button
        ...
        className="cursor-pointer absolute top-6 left-6 flex items-center gap-2 bg-white hover:bg-gray-50 text-gray-900 font-semibold px-4 py-2.5 rounded-xl shadow-md hover:shadow-lg transition-all border border-gray-200"
      >
      ...
      <div className="max-w-2xl w-full text-center">
        ...
        <div className="relative inline-block mb-8">
          ...
          <div className="relative w-24 h-24 bg-gradient-to-br from-yellow-400 to-yellow-500 rounded-full flex items-center justify-center shadow-xl mx-auto">
            <Utensils className="w-12 h-12 text-gray-900" />
          </div>
        </div>
