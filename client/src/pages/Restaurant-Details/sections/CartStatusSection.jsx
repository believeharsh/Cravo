...
const CartStatusSection = () => {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-50 bg-gray-900 text-white p-4 shadow-lg rounded-t-2xl">
      <div className="max-w-md mx-auto flex items-center justify-between">
        ...
        <button
          ...
          className="px-6 py-2 bg-yellow-400 text-gray-800 font-semibold rounded-full hover:bg-yellow-500 transition-colors"
        >
          View Cart
        </button>
      </div>
