...
const RestaurantGrid = () => {
  ...
  const limit = 10;
  const page = 2; // Note: This should usually be 1 or dynamic for real pagination
  ...
  return (
    <section className="py-6">
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        ...
        <button
          onClick={() => handleNavigateToCategoryResultPage('North Indian')}
          className="mt-8 text-yellow-600 hover:text-yellow-700 font-semibold text-sm transition-colors"
        >
          View more North Indian restaurants
