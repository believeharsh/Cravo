          ...
          <div className="p-6 space-y-4">
            ...
            <div className="space-y-3 pt-2">
              <button
                ...
                className="w-full bg-yellow-400 hover:bg-yellow-500 text-gray-800 font-semibold py-3 rounded-full transition-all shadow-md hover:shadow-lg"
              >
                Track Your Order
              </button>
              <div className="flex gap-3">
                <button
                  ...
                  className="flex-1 bg-gray-100 hover:bg-gray-200 text-gray-800 font-medium py-3 rounded-full transition-all"
                >
                  View Orders
                </button>
                <button
