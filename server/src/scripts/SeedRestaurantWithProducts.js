...
import delhiRestaurants from '../sample-Data/Restaurants-Data/DelhiRestaurants.js';
...
const seedDatabase = async () => {
  try {
    ...
    const cityForRestaurants = await City.findOne({ name: 'Delhi' });
    ...
    for (const restaurant of delhiRestaurants) {
