...
export const IndoreRestaurants = [
  ...
  // first 5 restaurant's seeding for indore :
  // {
  //     name: 'Maame Da Dhaba',
  ...
  // },
  // Second 5 restaurant's seeding for indore : 10
  // {
  ...
  // },
  // another 5 restaurant's seeding for indore : 15
  // {
  //     name: 'The Wok Master',
  ...
  // },
  // another 5 restaurant's seeding for indore : 20
  // {
  //     name: 'Burger Singh',
  ...
  // },
  // another 5 restaurant's seeding for indore : 25
  // {
  //     name: 'Healthy Hub',
  ...
  // },
  // another 5 restaurant's seeding for indore : 30
  // {
  //     name: 'Samurai Sushi',
  ...
  // },
  // another 5 restaurant's seeding for indore : 35
  // {
  ...
  // },
  // another 5 restaurant's seeding for indore : 40
  // {
  //   name: 'Veggie World',
  ...
  // },
  // another 5 restaurant's seeding for indore : 45
  // {
  ...
  // },
  // another 5 restaurant's seeding for indore : 50
  // {
