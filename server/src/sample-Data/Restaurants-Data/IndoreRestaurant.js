...
export const IndoreRestaurants = [
    ...
    //     cuisine_type: ['Indian', 'North-Indian', 'Lunch', 'Dinner', 'South-Indian'],
    ...
    //     cuisine_type: ['Italian', 'Pizza', 'Fast-Food', 'Beverages'],
    ...
    //     cuisine_type: ['Fast-Food', 'Burgers', 'Lunch', 'Dinner', 'Sandwiches', 'Beverages'],
    ...
    //     cuisine_type: ['Chinese', 'Lunch', 'Dinner', 'Fast-Food', 'Healthy', 'Vegan'],
    ...
    //     cuisine_type: ['Desserts', 'Beverages', 'Breakfast', 'Healthy', 'South-Indian'],
    ...
    //     cuisine_type: ['Mexican', 'Fast-Food', 'Beverages'],
    ...
    //     cuisine_type: ['Sushi', 'Japanese', 'Dinner'],
    ...
    //     cuisine_type: ['BBQ', 'Chinese', 'Dinner', 'Lunch'],
    ...
    //     cuisine_type: ['Sandwiches', 'Cafe', 'Lunch', 'Beverages', "Indian-Sweets"],
    ...
    //     cuisine_type: ['Chinese', 'Street-Food', 'Fast-Food'],
    ...
    //     cuisine_type: ['Italian', 'Pizaa', 'Dinner', 'Desserts'],
    ...
    //     cuisine_type: ['Burgers', 'Indian', 'Fast-Food', 'Street-Food'],
    ...
    //     cuisine_type: ['Chinese', 'Japanese', 'Dinner'],
    ...
    //     cuisine_type: ['Soups', 'Healthy', 'Lunch', 'Dinner', 'Vegan'],
    ...
    //     cuisine_type: ['Sushi', 'Soups', 'Japanese'],
    ...
    //     cuisine_type: ['Sandwiches', 'Lunch', 'Salads'],
    ...
    //     cuisine_type: ['North Indian', 'Indian', 'Desserts'],
    ...
    //     cuisine_type: ['Burgers', 'Pizza', 'Beverages', 'Fast-Food'],
    ...
    //     cuisine_type: ['Indian',  'Breakfast', 'Lunch', 'Dinner', 'South-Indian'],
    ...
    //     cuisine_type: ['Desserts', 'Beverages', 'Sandwiches', 'Indian-Sweets', 'Street-Food'],
    ...
    //     cuisine_type: ['Mexican', 'Italian', 'Sushi'],
    ...
    //     cuisine_type: ['BBQ', 'Dinner', 'Beverages', 'North-Indian'],
    ...
    //     cuisine_type: ['Beverages', 'Desserts', 'Fast-Food', 'Pizza'],
    //     rating: 4.5, numberOfReviews: 900,
    ...
    //     cuisine_type: ['Lunch', 'Indian', 'Indian-Sweets'],
    ...
    //     cuisine_type: ['Healthy', 'Breakfast', 'Lunch', 'Salads', 'Soups'],
    //     rating: 4.7, numberOfReviews: 600,
    ...
    //     cuisine_type: ['Indian', 'Fast-Food', 'Street-Food', 'Breakfast'],
    ...
    //     cuisine_type: ['Italian', 'Pizza', 'Mexican', 'Desserts'],
    //     rating: 4.6, numberOfReviews: 1200,
    //     opening_hours: [{ day: 'Saturday', open: '12:00', close: '23:00' }],
    //     is_active: true, min_order_value: 200, delivery_radius_km: 7,
    ...
    //     cuisine_type: ['Burgers', 'Fast-Food', 'Indian-Sweets', 'Beverages'],
    ...
    //     cuisine_type: ['Japanese', 'Sushi', 'Dinner', 'Lunch'],
    ...
    //     cuisine_type: ['Breakfast', 'Desserts', 'Beverages'],
    //     rating: 4.6, numberOfReviews: 800,
