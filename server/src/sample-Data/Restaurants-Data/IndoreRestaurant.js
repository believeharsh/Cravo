...
export const IndoreRestaurants = [
  ...
  // first 10 restaurant's seeding for indore :
  // {
  //     name: 'Maame Da Dhaba',
  ...
  //     cuisine_type: ['Italian', 'Pizza', 'Fast-Food', 'Beverages', 'Lunch', 'Dinner'],
  ...
  //     cuisine_type: ['Fast-Food', 'Burgers', 'Beverages', 'Lunch', 'Dinner', 'Sandwiches'],
  ...
  //     cuisine_type: ['Desserts', 'Beverages', 'Breakfast', 'Indian-Sweets', 'Fast-Food'],
  ...
  //     cuisine_type: ['Italian', 'Pizza', 'Fast-Food', 'Dinner', 'Desserts', 'Lunch'],
  ...
  //     cuisine_type: ['Beverages', 'Desserts', 'Breakfast', 'Sandwiches', 'Fast-Food'],
  ...
  //     cuisine_type: ['Burgers', 'Fast-Food', 'Indian', 'Street-Food', 'Lunch', 'Dinner'],
  ...
  //     cuisine_type: ['Desserts', 'Beverages', 'Breakfast', 'Sandwiches', 'Indian-Sweets'],
  ...
  //       cuisine_type: ['Healthy', 'Salads', 'Vegan', 'Soups', 'Lunch', 'Breakfast'],
  ...
  //       cuisine_type: ['Soups', 'Healthy', 'Sandwiches', 'Lunch', 'Dinner', 'Vegan'],
  ...
  //       cuisine_type: ['Sandwiches', 'Salads', 'Healthy', 'Breakfast', 'Lunch', 'Beverages'],
  ...
  //       cuisine_type: ['Burgers', 'Fast-Food', 'Pizza', 'Beverages', 'Lunch', 'Dinner'],
  ...
  //     imagePath:
  //       'https://media.istockphoto.com/id/1499768486/photo/sales-assistant-in-bakery-putting-gluten-free-label-into-freshly-baked-brownies.jpg?s=612x612&w=0&k=20&c=Cc0-jrSbRO1uOuja-Tkvyd4VBc4H5aY0Adhe489-DN0=',
  //   },
  //   {
  ...
  //     imagePath:
  //       'https://media.istockphoto.com/id/1475072762/photo/making-a-salad.jpg?s=612x612&w=0&k=20&c=hr_vLLQXpb6BRzNFfYH0ZlLEw9_DFBg1Pr0uPTWBmQQ=',
  //   },
  //   {
  ...
  //     imagePath:
  //       'https://media.istockphoto.com/id/628234210/photo/quesadilla-on-a-wooden-table.jpg?s=612x612&w=0&k=20&c=7eNzcl421I5Mso7t2LnfUjti2_nbY7XMwDnsvlnhnx4=',
  //   },
  //   {
  ...
  //     imagePath:
  //       'https://media.istockphoto.com/id/2149097599/photo/assorted-grilled-meats-and-vegetables-on-barbecue-ribs-lamb-chops-beef-turkey-chicken.jpg?s=612x612&w=0&k=20&c=g_nK-7T-VrRPp5ZPhW6HcCAsqzxnCYluPRDDAQ3rNW8=',
  //   },
  //   {
  //     name: 'Veggie World',
  ...
  //     delivery_time_mins: 30,
  //     imagePath:
  //       'https://media.istockphoto.com/id/1212329362/photo/table-top-view-of-indian-food.jpg?s=612x612&w=0&k=20&c=qLGeFzjZl10DmzgvF6mi1KAQVXHgCpBqgKaYx9DRzXw=',
  //   },
  //   {
  //     name: 'The South Indian Rasoi',
  //     description: 'Crispy dosas, idlis, and authentic South Indian thalis.',
  ...
  //       location: {
  //         type: 'Point',
  //         coordinates: [baseLon + 0.03, baseLat + 0.045],
  //       },
  //     },
  ...
  //     delivery_time_mins: 20,
  //     imagePath:
  //       'https://media.istockphoto.com/id/512752948/photo/chocolate-milkshake-with-whipped-cream.jpg?s=612x612&w=0&k=20&c=ngIDW6yk07lR2UDSQqtPyz2vuab8AA_iJlRrJYwNhhk=',
  //   },
  //   {
  //     name: 'The Lunch Box',
  ...
  //     cuisine_type: ['Lunch', 'Indian', 'North-Indian', 'Healthy', 'Dinner'],
  //     rating: 4.1,
  //     numberOfReviews: 400,
  ...
  //     address: {
  //       street: 'L.I.G. Colony, near Geeta Bhawan',
  //       city: 'Indore',
  //       state: 'Madhya Pradesh',
  //       zip_code: '452001',
  //       location: {
  ...
  //     cuisine_type: ['Dinner', 'Indian', 'North-Indian', 'South-Indian'],
  //     rating: 4.5,
  //     numberOfReviews: 800,
  //     opening_hours: [{ day: 'Monday', open: '18:00', close: '00:00' }],
  //     is_active: true,
  ...
  //     imagePath:
  //       'https://media.istockphoto.com/id/1164157153/photo/helthy-food-delivery-of-coil-cooking-meat-fish-and-vegetables.jpg?s=612x612&w=0&k=20&c=xHGRcIMc5MsTwV82wCKJE79ZwNjX8pHErqrysvaV5tU=',
  //   },
  ...
  //       cuisine_type: ['Healthy', 'Breakfast', 'Lunch', 'Salads', 'Soups', 'Vegan'],
  //       rating: 4.7, numberOfReviews: 600,
  ...
  //       cuisine_type: ['Soups', 'Sandwiches', 'Healthy', 'Lunch', 'Dinner', 'Vegan'],
  ...
  //       cuisine_type: ['Desserts', 'Beverages', 'Indian-Sweets', 'Breakfast', 'Fast-Food'],
  //       rating: 4.9, numberOfReviews: 1500,
...

  {
    ...
    delivery_time_mins: 30,
    imagePath:
      'https://media.istockphoto.com/id/504424770/photo/breakfast-on-valentines-day-fried-eggs.jpg?s=612x612&w=0&k=20&c=SQXchOVyz_fU1Cs2W3GhKY3-dm73crULlDYowf3Ot_g=',
  },
  {
    name: 'Harsh Cafe',
